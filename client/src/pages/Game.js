    ...
    return (
      <div className='poker-app--background'>
        <div className="table-header-container">
          <div className="table-header-container-content">
            <div className="header-buttons left-buttons">
              <div className="panel button table-header-button lobby-button" tabIndex={-1}  onClick={() => this.props.onNavigate('lobby')}>
        ...
        <div className="poker-table--container">
          <div className="poker-table--table-felt-image" alt="Poker Main Table" />
          <div className="poker-table--table-image" alt="Poker Table" />
          <div className="poker-table--table-logo" alt="Poker Logo" />
          { this.renderBoard() }
          <div className='community-card-container' >
            { this.renderCommunityCards() }
          </div>
          <div className='pot-container'>
            <img style={{height: 55, width: 55}} src={'./assets/pot.png'} alt="Pot Value"/>
