...
function Game({ setConnected }) {
  ...
  const [chipsAmount, setChipsAmount] = React.useState(user.chipsAmount);
  ...
  React.useEffect(() => {
    ...
    socket.on(PLAYERS_UPDATED, (players) => {
      ...
      players[socketIdRef.current] &&
        setChipsAmount(players[socketIdRef.current].chipsAmount);
    });
    ...
    <div className="mt-5 container">
      <div className="mt-3 row">
        <div className="col-4">
          ...
          <br />
          <strong>Bankroll:</strong> {chipsAmount}
        </div>
        <div className="col-4">
